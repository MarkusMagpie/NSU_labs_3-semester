...
g++ -c AmplifyConverter.cpp -o AmplifyConverter.o
...
g++ main.o ConfigParser.o MuteConverter.o MixConverter.o AmplifyConverter.o SoundProcessor.o WAVFileReader.o WAVFileWriter.o -o audio_processor
